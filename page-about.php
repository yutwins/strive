<?php get_header(); ?>
    ...
    <div class="page-container">
        <div class="page-contents">
            <section class="section ledVision">
                <h4 class="section__enTitle section__enTitle--right ledVision__enTitle">LED VISION</h4>
                <div class="inner ledVision-inner">
                    <div class="ledVision-container">
                        <div class="ledVision-textArea">
                            <h2 class="ledVision__head">LEDビジョンとは？</h2>
            ...
            <section class="section ledVision-feature">
                <h4 class="section__enTitle section__enTitle--right ledVision-feature__enTitle">FEATURE</h4>
                <div class="inner ledVision-feature__inner">
                    <h2 class="ledVision-feature__head gradation-text">LEDビジョンの特徴</h2>
                    <ul class="ledVision-feature__items">
                        <li class="ledVision-feature__item">
                            ...
                            <div class="ledVision-feature__itemTextArea">
                                ...
                                <p class="ledVision-feature__itemText">テレビやパソコンモニターの5倍程度の明るさがあり、日中の太陽があたっても光や映像を鮮明に表示されます。</p>
                            </div>
                        </li>
                        <li class="ledVision-feature__item">
                            <figure class="ledVision-feature__itemImgArea">
                            ...
                            <div class="ledVision-feature__itemTextArea">
                                ...
                                <p class="ledVision-feature__itemText">LEDチップの寿命が約10万時間に対し、液晶ディスプレイは約3万時間です。またLEDチップは、球切れもほとんどなく、ランニングコストを抑えることができます。</p>
                            </div>
                        </li>
                        <li class="ledVision-feature__item">
                            <figure class="ledVision-feature__itemImgArea">
                            ...
                            <div class="ledVision-feature__itemTextArea">
                                ...
                                <p class="ledVision-feature__itemText">屋外用LEDビジョンは防水・防塵機能が備わっており、屋外でのイベントなどでご活用いただけます。</p>
                            </div>
                        </li>
                        <li class="ledVision-feature__item">
                            <figure class="ledVision-feature__itemImgArea">
                            ...
                            <div class="ledVision-feature__itemTextArea">
                                ...
                                <p class="ledVision-feature__itemText">LEDビジョンはパネルをタイルのように組み合わせており、パネル自体が薄いため、球面や円形を含め自由な形に組む事が出来ます。</p>
                            </div>
                        </li>
                        <li class="ledVision-feature__item">
                            <figure class="ledVision-feature__itemImgArea">
                            ...
                            <div class="ledVision-feature__itemTextArea">
                                ...
                                <p class="ledVision-feature__itemText">消費電力が白熱電球に比べて10分の1で、電気代を節約することができます。</p>
                            </div>
                        </li>
                        <li class="ledVision-feature__item">
                            <figure class="ledVision-feature__itemImgArea">
                            ...
                            <div class="ledVision-feature__itemTextArea">
                                ...
                                <p class="ledVision-feature__itemText">LEDビジョンは小さなユニットの集合で構成されているため、そのユニットごとに修理やメンテナンスが可能であり、費用や工数を大幅に抑えることができます。</p>
                            </div>
                        </li>
                    </ul>
                </div>
            ...
            <section class="section PixelPitch">
                <h4 class="section__enTitle section__enTitle--right PixelPitch__enTitle">PIXEL PITCH</h4>
                <div class="inner PixelPitch-inner">
                    <h2 class="PixelPitch__head">ピクセルピッチ<br class="sp-only">とは？</h2>
                    <div class="PixelPitch-top">
                        <div class="PixelPitch-topTextArea">
                            <h4 class="PixelPitch-top__head">
                                このLED球の間隔を<br>
                                ピクセルピッチと呼びます。
                            </h4>
                            <p class="PixelPitch-top__text">ピクセルピッチの間隔が小さいほど高解像度な映像を表示することができます。その分LED球を多く使用するため、高価になります。</p>
                        </div>
            ...
            <section class="section ledVisionPoints">
                <h4 class="section__enTitle section__enTitle--right ledVisionPoints__enTitle">CHOOSE POINTS</h4>
                <div class="inner ledVisionPoints-inner">
                    <h2 class="ledVisionPoints__head">LEDビジョンを<br class="sp-only">選ぶ時のポイント</h2>
                    <ol class="ledVisionPoints-items">
                        <li class="ledVisionPoints-item">
                            <div class="ledVisionPoints-item__headArea">
                                <p class="ledVisionPoints-item__head--num">01</p>
                                <p class="ledVisionPoints-item__head">視認距離</p>
                            </div>
                            <div class="ledVisionPoints-item--right">
                                <p class="ledVisionPoints-item01__text">設置する場所の視認距離に応じて、最適なピッチを選びます</p>
                                <div class="ledVisionPoints-item01__desc">
                        ...
                        <li class="ledVisionPoints-item">
                            <div class="ledVisionPoints-item__headArea">
                                <p class="ledVisionPoints-item__head--num">02</p>
                                <p class="ledVisionPoints-item__head">輝度</p>
                            </div>
                            <div class="ledVisionPoints-item--right ledVisionPoints-item02--right">
                                <ul class="ledVisionPoints-item02__ul">
                                    <li class="ledVisionPoints-item02__list">
                                        ...
                                        <p class="ledVisionPoints-item02__listLuminance">300~500cd</p>
                                    </li>
                                    <li class="ledVisionPoints-item02__list">
                                        <picture>
                                        ...
                                        <p class="ledVisionPoints-item02__listLuminance">300~700cd</p>
                                    </li>
                                    <li class="ledVisionPoints-item02__list">
                                        <picture>
                                        ...
                                        <p class="ledVisionPoints-item02__listLuminance">1000~1500cd</p>
                                    </li>
                                    <li class="ledVisionPoints-item02__list">
                                        <picture>
                                        ...
                                        <p class="ledVisionPoints-item02__listLuminance">4500~1000cd</p>
                                    </li>
                                </ul>
                        ...
                        <li class="ledVisionPoints-item">
                            <div class="ledVisionPoints-item__headArea">
                                <p class="ledVisionPoints-item__head--num">03</p>
                                <p class="ledVisionPoints-item__head">素子</p>
                            </div>
                            <div class="ledVisionPoints-item--right">
                                <ul class="ledVisionPoints-item03__ul">
                                    <li class="ledVisionPoints-item03__list">
                                        ...
                                        <div class="ledVisionPoints-item03__listTextArea">
                                            <p class="ledVisionPoints-item03__listHead">SMD 3 in 1 LED</p>
                                            <p class="ledVisionPoints-item03__listText">RGBの3種のLEDチップを1つのチップに組み合わせたLEDです。 ピクセルピッチが詰めやすいため、高機能なLEDビジョンを構成できます。→人とビジョンの距離が近い場合に適しています。</p>
                                        </div>
                                    </li>
                                    <li class="ledVisionPoints-item03__list">
                                        <figure class="ledVisionPoints-item03__listImgArea">
                                        ...
                                        <div class="ledVisionPoints-item03__listTextArea">
                                            <p class="ledVisionPoints-item03__listHead">GOB</p>
                                            <p class="ledVisionPoints-item03__listText">種通常のSMD方式（一般的にはP2mm台以上）に樹脂コーディングの表面保護を施したもので高精細ピッチに対応。高強度で防塵・防水。某静電気の特徴があります。</p>
                                        </div>
                                    </li>
                                    <li class="ledVisionPoints-item03__list">
                                        <figure class="ledVisionPoints-item03__listImgArea">
                                        ...
                                        <div class="ledVisionPoints-item03__listTextArea">
                                            <p class="ledVisionPoints-item03__listHead">COB</p>
                                            <p class="ledVisionPoints-item03__listText">Chip On Boardの略で基盤の上にチップが載っている構造。<br>超高精細なLEDビジョンを構成することができ耐衝撃性にも優れています。→衝撃に強いため人が触れる至近距離に適しています。</p>
                                        </div>
                                    </li>
                                </ul>
                            </div>
