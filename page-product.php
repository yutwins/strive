<?php get_header(); ?>
    ...
    <div class="page-container">
        <div class="page-contents">
            <section class="section pageProduct">
                        ...
                        <div id="pageProduct-item01" class="pageProduct-item">
                            ...
                            <div class="pageProduct-contents">
                                ...
                                <div class="pageProduct-dlArea">
                                    <dl class="pageProduct-dl">
                                        <div class="pageProduct-row">
                                            <dt class="pageProduct-dt">ピクセルピッチ</dt>
                                            <dd class="pageProduct-dd">2.5mm</dd>
                                        </div>
                                        <div class="pageProduct-row">
                                            <dt class="pageProduct-dt">輝度</dt>
                                            <dd class="pageProduct-dd">800 nits</dd>
                                        </div>
                                        <div class="pageProduct-row">
                                            <dt class="pageProduct-dt">モジュールサイズ</dt>
                                            <dd class="pageProduct-dd">240mm X 120mm</dd>
                                        </div>
                                        <div class="pageProduct-row">
                                            <dt class="pageProduct-dt">キャビネットサイズ</dt>
                                            <dd class="pageProduct-dd">自由にカスタマイズ可能</dd>
                                        </div>
                                    </dl>
                                    <dl class="pageProduct-dl">
                                        <div class="pageProduct-row">
                                            <dt class="pageProduct-dt">キャビネット重量</dt>
                                            <dd class="pageProduct-dd">32kg/m2</dd>
                                        </div>
                                        <div class="pageProduct-row">
                                            <dt class="pageProduct-dt">入力電圧</dt>
                                            <dd class="pageProduct-dd">ac100-240v 50/60 hz</dd>
                                        </div>
                                        <div class="pageProduct-row">
                                            <dt class="pageProduct-dt">消費電力 (平均)</dt>
                                            <dd class="pageProduct-dd">175w/sqm</dd>
                                        </div>
                                        <div class="pageProduct-row">
                                            <dt class="pageProduct-dt">消費電力 (最大)</dt>
                                            <dd class="pageProduct-dd">580w/sqm</dd>
                                        </div>
                                    </dl>
                                </div>
                            </div>
                            ...
                            <div class="pageProduct-contents">
                                ...
                                <div class="pageProduct-dlArea">
                                    <dl class="pageProduct-dl">
                                        <div class="pageProduct-row">
                                            <dt class="pageProduct-dt">ピクセルピッチ</dt>
                                            <dd class="pageProduct-dd">3.91mm 〜 7.8mm</dd>
                                        </div>
                                        <div class="pageProduct-row">
                                            <dt class="pageProduct-dt">輝度</dt>
                                            <dd class="pageProduct-dd">800 〜 5000 nits</dd>
                                        </div>
                                        <div class="pageProduct-row">
                                            <dt class="pageProduct-dt">モジュールサイズ</dt>
                                            <dd class="pageProduct-dd">500mm X 125mm X 20mm</dd>
                                        </div>
                                        <div class="pageProduct-row">
                                            <dt class="pageProduct-dt">キャビネットサイズ</dt>
                                            <dd class="pageProduct-dd">500mm X 1000mm X 75mm</dd>
                                        </div>
                                    </dl>
                                    <dl class="pageProduct-dl">
                                        <div class="pageProduct-row">
                                            <dt class="pageProduct-dt">キャビネット重量</dt>
                                            <dd class="pageProduct-dd">4.5kg</dd>
                                        </div>
                                        <div class="pageProduct-row">
                                            <dt class="pageProduct-dt">入力電圧</dt>
                                            <dd class="pageProduct-dd">ac100〜240v 50/60 hz</dd>
                                        ...
                                        <div class="pageProduct-row">
                                            <dt class="pageProduct-dt">消費電力 (平均)</dt>
                                            <dd class="pageProduct-dd">120w/sqm</dd>
                                        </div>
                                        <div class="pageProduct-row">
                                            <dt class="pageProduct-dt">消費電力 (最大)</dt>
                                            <dd class="pageProduct-dd">400w/sqm</dd>
                                        </div>
                                    </dl>
                                </div>
                            </div>
                            ...
                            <div class="pageProduct-contents">
                                ...
                                <div class="pageProduct-dlArea">
                                    <dl class="pageProduct-dl">
                                        <div class="pageProduct-row">
                                            <dt class="pageProduct-dt">ピクセルピッチ</dt>
                                            <dd class="pageProduct-dd">1.25mm</dd>
                                        </div>
                                        <div class="pageProduct-row">
                                            <dt class="pageProduct-dt">輝度</dt>
                                            <dd class="pageProduct-dd">600 nits</dd>
                                        </div>
                                        <div class="pageProduct-row">
                                            <dt class="pageProduct-dt">モジュールサイズ</dt>
                                            <dd class="pageProduct-dd">320mm X 160mm x 3mm </dd>
                                        </div>
                                        <div class="pageProduct-row">
                                            <dt class="pageProduct-dt">キャビネットサイズ</dt>
                                            <dd class="pageProduct-dd">640mm X 480mm x 46mm</dd>
                                        </div>
                                    </dl>
                                    <dl class="pageProduct-dl">
                                        <div class="pageProduct-row">
                                            <dt class="pageProduct-dt">キャビネット重量</dt>
                                            <dd class="pageProduct-dd">7.5kg</dd>
                                        </div>
                                        <div class="pageProduct-row">
                                            <dt class="pageProduct-dt">入力電圧</dt>
                                            <dd class="pageProduct-dd">ac110v〜240V 50/60 hz</dd>
                                        </div>
                                        <div class="pageProduct-row">
                                            <dt class="pageProduct-dt">消費電力 (平均)</dt>
                                            <dd class="pageProduct-dd">180w/sqm</dd>
                                        </div>
                                        <div class="pageProduct-row">
                                            <dt class="pageProduct-dt">消費電力 (最大)</dt>
                                            <dd class="pageProduct-dd">600w/sqm</dd>
                                        </div>
                                    </dl>
                                </div>
                            </div>
                            ...
                            <div class="pageProduct-contents">
                                ...
                                <div class="pageProduct-dlArea">
                                    <dl class="pageProduct-dl">
                                        ...
                                        <div class="pageProduct-row">
                                            <dt class="pageProduct-dt">輝度</dt>
                                            <dd class="pageProduct-dd">1200 nits</dd>
                                        </div>
                                        <div class="pageProduct-row">
                                            <dt class="pageProduct-dt">モジュールサイズ</dt>
                                            <dd class="pageProduct-dd">320mm X 160mm</dd>
                                        </div>
                                        <div class="pageProduct-row">
                                            <dt class="pageProduct-dt">キャビネットサイズ</dt>
                                            <dd class="pageProduct-dd">640mm X 1920mm</dd>
                                        </div>
                                    </dl>
                                    <dl class="pageProduct-dl">
                                        <div class="pageProduct-row">
                                            <dt class="pageProduct-dt">キャビネット重量</dt>
                                            <dd class="pageProduct-dd">41.5kg</dd>
                                        </div>
                                        <div class="pageProduct-row">
                                            <dt class="pageProduct-dt">入力電圧</dt>
                                            <dd class="pageProduct-dd">ac110-240v 50/60 hz</dd>
                                        </div>
                                        <div class="pageProduct-row">
                                            <dt class="pageProduct-dt">消費電力 (平均)</dt>
                                            <dd class="pageProduct-dd">203w/pc</dd>
                                        </div>
                                        <div class="pageProduct-row">
                                            <dt class="pageProduct-dt">消費電力 (最大)</dt>
                                            <dd class="pageProduct-dd">675w/pc</dd>
                                        </div>
                                    </dl>
                                </div>
                                <div class="pageProduct-dlArea">
                                    <dl class="pageProduct-dl">
                                        <div class="pageProduct-row">
                                            <dt class="pageProduct-dt">ピクセルピッチ</dt>
                                            <dd class="pageProduct-dd">1.8mm</dd>
                                        </div>
                                        <div class="pageProduct-row">
                                            <dt class="pageProduct-dt">輝度</dt>
                                            <dd class="pageProduct-dd">1000 nits</dd>
                                        </div>
                                        <div class="pageProduct-row">
                                            <dt class="pageProduct-dt">モジュールサイズ</dt>
                                            <dd class="pageProduct-dd">320mm X 160mm</dd>
                            ...
                            <div class="pageProduct-contents">
                                ...
                                <div class="pageProduct-dlArea">
                                    <dl class="pageProduct-dl">
                                        <div class="pageProduct-row">
                                            <dt class="pageProduct-dt">ピクセルピッチ</dt>
                                            <dd class="pageProduct-dd">2.9mm</dd>
                                        </div>
                                        <div class="pageProduct-row">
                                            <dt class="pageProduct-dt">輝度</dt>
                                            <dd class="pageProduct-dd">4500 〜 5000 nits</dd>
                                        </div>
                                        <div class="pageProduct-row">
                                            <dt class="pageProduct-dt">モジュールサイズ</dt>
                                            <dd class="pageProduct-dd">250mm X 250mm</dd>
                                        </div>
                                        <div class="pageProduct-row">
                                            <dt class="pageProduct-dt">キャビネットサイズ</dt>
                                            <dd class="pageProduct-dd">500mm X 1000mm</dd>
                                        </div>
                                    </dl>
                                    <dl class="pageProduct-dl">
                                        <div class="pageProduct-row">
                                            <dt class="pageProduct-dt">キャビネット重量</dt>
                                            <dd class="pageProduct-dd">13kg</dd>
                                        </div>
                                        <div class="pageProduct-row">
                                            <dt class="pageProduct-dt">入力電圧</dt>
                                            <dd class="pageProduct-dd">ac110〜240v 50/60 hz</dd>
                                        ...
                                        <div class="pageProduct-row">
                                            <dt class="pageProduct-dt">消費電力 (平均)</dt>
                                            <dd class="pageProduct-dd">192w/sqm</dd>
                                        </div>
                                        <div class="pageProduct-row">
                                            <dt class="pageProduct-dt">消費電力 (最大)</dt>
                                            <dd class="pageProduct-dd">640w/sqm</dd>
                                        </div>
                                    </dl>
                                </div>
                                <div class="pageProduct-dlArea">
                                    <dl class="pageProduct-dl">
                                        <div class="pageProduct-row">
                                            <dt class="pageProduct-dt">ピクセルピッチ</dt>
                                            <dd class="pageProduct-dd">3.9mm</dd>
                                        </div>
                                        <div class="pageProduct-row">
                                            <dt class="pageProduct-dt">輝度</dt>
                                            <dd class="pageProduct-dd">4500 〜 5000 nits</dd>
                                ...
                                <div class="pageProduct-dlArea">
                                    <dl class="pageProduct-dl">
                                        <div class="pageProduct-row">
                                            <dt class="pageProduct-dt">ピクセルピッチ</dt>
                                            <dd class="pageProduct-dd">4.81mm</dd>
                                        </div>
                                        <div class="pageProduct-row">
                                            <dt class="pageProduct-dt">輝度</dt>
                                            <dd class="pageProduct-dd">4500 〜 5000 nits</dd>
                            ...
                            <div class="pageProduct-contents">
                                ...
                                <div class="pageProduct-dlArea">
                                    <dl class="pageProduct-dl">
                                        <div class="pageProduct-row">
                                            <dt class="pageProduct-dt">ピクセルピッチ</dt>
                                            <dd class="pageProduct-dd">4.0mm</dd>
                                        </div>
                                        <div class="pageProduct-row">
                                            <dt class="pageProduct-dt">輝度</dt>
                                            <dd class="pageProduct-dd">5000 - 6000 nits</dd>
                                        </div>
                                        <div class="pageProduct-row">
                                            <dt class="pageProduct-dt">モジュールサイズ</dt>
                                            <dd class="pageProduct-dd">320mm X 160mm</dd>
                                        ...
                                        <div class="pageProduct-row">
                                            <dt class="pageProduct-dt">キャビネットサイズ</dt>
                                            <dd class="pageProduct-dd">960mm X 960mm</dd>
                                        </div>
                                    </dl>
                                    <dl class="pageProduct-dl">
                                        <div class="pageProduct-row">
                                            <dt class="pageProduct-dt">キャビネット重量</dt>
                                            <dd class="pageProduct-dd">25kg</dd>
                                        </div>
                                        <div class="pageProduct-row">
                                            <dt class="pageProduct-dt">入力電圧</dt>
                                            <dd class="pageProduct-dd">ac110-240v 50/60 hz</dd>
                                        ...
                                        <div class="pageProduct-row">
                                            <dt class="pageProduct-dt">消費電力 (平均)</dt>
                                            <dd class="pageProduct-dd">240w/sqm</dd>
                                        </div>
                                        <div class="pageProduct-row">
                                            <dt class="pageProduct-dt">消費電力 (最大)</dt>
                                            <dd class="pageProduct-dd">800w/sqm</dd>
                                        </div>
                                    </dl>
                                </div>
                                <div class="pageProduct-dlArea">
                                ...
                                <div class="pageProduct-dlArea">
                                    <dl class="pageProduct-dl">
                                        <div class="pageProduct-row">
                                            <dt class="pageProduct-dt">ピクセルピッチ</dt>
                                            <dd class="pageProduct-dd">10.0mm（省エネ）</dd>
                                        </div>
                                        <div class="pageProduct-row">
                                            <dt class="pageProduct-dt">輝度</dt>
                                            <dd class="pageProduct-dd">7000 nits</dd>
                                        </div>
                                        <div class="pageProduct-row">
                                            <dt class="pageProduct-dt">モジュールサイズ</dt>
                                            <dd class="pageProduct-dd">320mm X 160mm</dd>
                                    ...
                                    <dl class="pageProduct-dl">
                                        ...
                                        <div class="pageProduct-row">
                                            <dt class="pageProduct-dt">消費電力 (平均)</dt>
                                            <dd class="pageProduct-dd">165W/sqm</dd>
                                        </div>
                                        <div class="pageProduct-row">
                                            <dt class="pageProduct-dt">消費電力 (最大)</dt>
                                            <dd class="pageProduct-dd">550W/sqm</dd>
                                        </div>
                                    </dl>
                                </div>
                            </div>
